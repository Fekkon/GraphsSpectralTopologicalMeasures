...
logfile='mxx_04_hvg_250_1_spec.txt';
...
fp=fopen(logfile,'a');
fprintf(fp,'filename\tt\tmax node degree\tmin node degree\tmean node degree\tmaxGrSpectr\tminGrSpec\tmeanGrSpec\tAlgConnect\tmaxFiedVectn\tminFiedVectn\tmeanFiedVectn\tEigence\tGraph_ener\tgraphsSpectralDelta_wrongforlaplacian\n');
fclose(fp);
for i=1:tstep:n-wind % главный цикл
    ...
    gr_sp_adj=graph_spectrum_adjmatr_unsort(Adj);
