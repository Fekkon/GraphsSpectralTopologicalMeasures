function graphs_in_window_topologic_fun(filename,wind,tstep,thr_fr,crp_emb_dimm, crp_delay, crp_epsilon, logfile, graph_type, docalcentr, skip_complex_measures, p, k, beta, n_pref, m_pref, rmt_multiplier,adjmatrixfile);
...
%logfile='SP500_1983_05112013_vg_250_5.txt';
%graph_type=2; % 1 - crp, 2 - visibility graph, 3 - horizontal visibility graph
